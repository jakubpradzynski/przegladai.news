...
| Tekst z wyraźnym autorem, opinia | `<Autor>: <teza>` albo `<Autor> <czasownik> …` | „Dario Amodei: musimy kontrolować tempo rozwoju AI”, „Dan Luu sprawdza, czy agenci AI potrafią dobrze testować kod” |
