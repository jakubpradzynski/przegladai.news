...
## Wytyczne
1. Uruchom skrypt serwera lokalnego `python3 .agents/skills/run-article-selection/scripts/server.py` w tle. Pamiętaj o ustawieniu flagi `is_background` na `true` w `run_shell_command`.
